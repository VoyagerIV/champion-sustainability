      ...
      <Carousel
        ...
        renderItem={({ item, index }) => (
          <TouchableOpacity
            ...
            onPress={() => {
              if (item.t === "Cherry Blossom Planting") {
                navigation.navigate("Event", {
                  image:
                    "https://www.cumberland.nsw.gov.au/sites/default/files/styles/16_9_mobile/public/2019-10/Cherry-Blossom-Festival-2of2-1282x600_3.jpg?h=be6aa2d1&itok=EU3Xt7xp",
                  title: item.t,
                  organiser: "Ben Marcus",
                  date: "12/12/2022",
                  time: "10:00 AM - 3:00 PM",
                  location: "Auburn NSW 2144",
                  attendees: 25,
                  capacity: 51,
                  categories: [],
                  status: "",
                  description:
                    "A great experience for anyone who loves gardening.",
                  comments: [
                    {
                      poster: "johnsmith",
                      posterImg:
